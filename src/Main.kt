...
fun main() {
    ...
    val cafeteteras = listOf(cafetera1, cafetera2, cafetera3)

    //TODO: Crear una lista de 20 tazas con capacidades aleatorias
    val tazas = GestionDeCafes.crearListaTazas()

    println("**********************************************")
    //TODO: Mostrar por pantalla el contenido de las 3 cafeteras y las tazas.

    GestionDeCafes.mostrarInfo(tazas, listOf(cafetera1, cafetera2, cafetera3))
    ...
    GestionDeCafes.mostrarCafeteras(cafeteras)
